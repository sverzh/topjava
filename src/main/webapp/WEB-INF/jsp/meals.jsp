                ...
                <form id="filter">
                    <div class="row">
                        ...
                        <div class="col-2">
                            ...
                            <input class="form-control" type="date" id="endDate" autocomplete="off">
                        </div>
                        <div class="offset-2 col-3">
                            <label for="startTime"><spring:message code="meal.startTime"/>:</label>
                            <input class="form-control" type="time" id="startTime" autocomplete="off">
                        </div>
                        <div class="col-3">
                            <label for="endTime"><spring:message code="meal.endTime"/>:</label>
                            <input class="form-control" type="time" id="endTime" autocomplete="off">
                        </div>
                    </div>
                </form>
